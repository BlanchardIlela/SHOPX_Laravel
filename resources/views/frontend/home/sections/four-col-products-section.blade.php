        ...
        <div class="row">
                ...
                <div class="product-list-small animated animated">
                    <article class="row align-items-center hover-up">
                        <figure class="col-sm-4 mb-0">
                            <a href="#"><img src="{{ asset('assets/frontend/imgs/shop/thumbnail-1.jpg') }}"
                                    alt="" /></a>
                        </figure>
            ...
            <div class="col-6 col-xl-3 col-lg-4 col-md-6 mb-30 wow animate__animated animate__fadeInUp"
                ...
                <div class="product-list-small animated animated">
                    <article class="row align-items-center hover-up">
                        <figure class="col-sm-4 mb-0">
                            <a href="#"><img src="{{ asset('assets/frontend/imgs/shop/thumbnail-4.jpg') }}"
                                    alt="" /></a>
                        </figure>
                        <div class="col-sm-8 mb-0">
                            <h6>
                    ...
                    <article class="row align-items-center hover-up">
                        <figure class="col-sm-4 mb-0">
                            <a href="#"><img src="{{ asset('assets/frontend/imgs/shop/thumbnail-5.jpg') }}"
                                    alt="" /></a>
                        </figure>
                        <div class="col-sm-8 mb-0">
                            <h6>
                    ...
                    <article class="row align-items-center hover-up">
                        <figure class="col-sm-4 mb-0">
                            <a href="#"><img src="{{ asset('assets/frontend/imgs/shop/thumbnail-6.jpg') }}"
                                    alt="" /></a>
                        </figure>
                        <div class="col-sm-8 mb-0">
                            <h6>
            ...
            <div class="col-6 col-xl-3 col-lg-4 col-md-6 mb-30 wow animate__animated animate__fadeInUp"
                ...
                <div class="product-list-small animated animated">
                    ...
                    <article class="row align-items-center hover-up">
                        <figure class="col-sm-4 mb-0">
                            <a href="#"><img src="{{ asset('assets/frontend/imgs/shop/thumbnail-8.jpg') }}"
                                    alt="" /></a>
                        </figure>
                        <div class="col-sm-8 mb-0">
                            <h6>
                    ...
                    <article class="row align-items-center hover-up">
                        <figure class="col-sm-4 mb-0">
                            <a href="#"><img src="{{ asset('assets/frontend/imgs/shop/thumbnail-9.jpg') }}"
                                    alt="" /></a>
                        </figure>
                        <div class="col-sm-8 mb-0">
                            <h6>
            ...
            <div class="col-6 col-xl-3 col-lg-4 col-md-6 mb-30 wow animate__animated animate__fadeInUp"
                ...
                <div class="product-list-small animated animated">
                    <article class="row align-items-center hover-up">
                        <figure class="col-sm-4 mb-0">
                            <a href="#"><img src="{{ asset('assets/frontend/imgs/shop/thumbnail-10.jpg') }}"
                                    alt="" /></a>
                        </figure>
                        <div class="col-sm-8 mb-0">
                            <h6>
                    ...
                    <article class="row align-items-center hover-up">
                        <figure class="col-sm-4 mb-0">
                            <a href="#"><img src="{{ asset('assets/frontend/imgs/shop/thumbnail-11.jpg') }}"
                                    alt="" /></a>
                        </figure>
                        <div class="col-sm-8 mb-0">
                            <h6>
                    ...
                    <article class="row align-items-center hover-up">
                        <figure class="col-sm-4 mb-0">
                            <a href="#"><img src="{{ asset('assets/frontend/imgs/shop/thumbnail-12.jpg') }}"
                                    alt="" /></a>
                        </figure>
                        <div class="col-sm-8 mb-0">
                            <h6>
