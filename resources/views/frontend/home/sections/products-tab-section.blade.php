                                ...
                                <div class="product-img product-img-zoom">
                                    <a href="#" tabindex="-1">
                                        <img class="default-img"
                                            src="{{ 'assets/frontend/imgs/shop/product-2-1.jpg' }}" alt="">
                                        <img class="hover-img"
                                            src="{{ 'assets/frontend/imgs/shop/product-2-2.jpg' }}" alt="">
                                    </a>
                                </div>
                                <div class="product-action-1">
                                    <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i
                        ...
                        <div class="product-cart-wrap mb-30" data-wow-delay=".3s">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="#" tabindex="-1">
                                        <img class="default-img"
                                            src="{{ 'assets/frontend/imgs/shop/product-3-1.jpg' }}" alt="">
                                        <img class="hover-img"
                                            src="{{ 'assets/frontend/imgs/shop/product-3-2.jpg' }}" alt="">
                                    </a>
                                </div>
                                <div class="product-action-1">
                                    <a aria-label="Add To Wishlist" class="action-btn" href="shop-wishlist.html"><i
